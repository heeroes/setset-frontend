...
<template>
  <div class="relative py-3 sm:max-w-xl sm:mx-auto">
    <div
      class="relative px-4 py-10 bg-white mx-8 md:mx-0 my-10 shadow rounded-3xl sm:p-10"
    >
      <div class="max-w-md mx-auto">
        <div class="flex items-center space-x-5 justify-center py-5">
          <span class="ml-2 text-3xl font-extrabold">Login</span>
        </div>
        ...
        <div class="flex justify-center w-full items-center">
          <div>
            <button
              class="flex items-center justify-center py-2 px-20 bg-white hover:bg-gray-200 focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg mb-4"
              @click="login(GOOGLE_URL)"
            >
              <svg
                viewBox="0 0 24 24"
                height="25"
            ...
            >
              ...
              <span class="ml-2">Sign in with Naver</span>
            </button>
          </div>
        </div>
      </div>
